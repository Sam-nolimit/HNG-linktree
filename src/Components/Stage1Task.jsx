...
export const Stage1Task = ({ ...props }) => {
  return (
    <div className="stage-1-task">
      <div className="main-section">
        <div className="content">
          <div className="profile-section">
            <div className="profile__img"></div>
            <div className="twitter">
              <div className="annette-black">Annette Black</div>
            </div>
            <div className="_avatar-share-button">
          ...
          <div className="link-section">
            <div className="links">
              <div className="frame-5">
                <div className="text">Twitter Link</div>
              </div>
            </div>
            <div className="btn__zuri">
              <div className="frame-5">
                <div className="text2">Zuri Team</div>
              </div>
            </div>
            <div className="books">
              <div className="frame-5">
                <div className="text2">Zuri Books</div>
              </div>
            </div>
            <div className="book__python">
              <div className="frame-5">
                <div className="text2">Python Books</div>
              </div>
            </div>
            <div className="pitch">
              <div className="frame-5">
                <div className="text2">Background Check for Coders</div>
              </div>
            </div>
            <div className="book_design">
              <div className="frame-5">
                <div className="text2">Design Books</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="content3">
            <div className="social-icons">
              <div className="slack">
                ...
                >
                  <path
                    d="M17.8752 9.2498C18.9106 9.2498 19.75 8.41041 19.75 7.37496V7.37496C19.75 6.33952 18.9105 5.50012 17.8751 5.50012V5.50012C16.8395 5.50012 16 6.33959 16 7.37512V9.2498H17.8752ZM12.625 9.2498C13.6605 9.2498 14.5 8.41033 14.5 7.3748V2.12512C14.5 1.08959 13.6605 0.250122 12.625 0.250122V0.250122C11.5895 0.250122 10.75 1.08959 10.75 2.12512V7.3748C10.75 8.41033 11.5895 9.2498 12.625 9.2498V9.2498Z"
                    fill="#2EB67D"
                  />
                  <path
                    d="M2.12484 10.7502C1.08939 10.7502 0.250001 11.5896 0.250001 12.625V12.625C0.250001 13.6605 1.08947 14.4999 2.12492 14.4999V14.4999C3.16045 14.4999 4 13.6604 4 12.6249V10.7502H2.12484ZM7.375 10.7502C6.33947 10.7502 5.5 11.5897 5.5 12.6252V17.8749C5.5 18.9104 6.33947 19.7499 7.375 19.7499V19.7499C8.41053 19.7499 9.25 18.9104 9.25 17.8749V12.6252C9.25 11.5897 8.41053 10.7502 7.375 10.7502V10.7502Z"
                    fill="#E01E5A"
                  />
                  <path
                    d="M10.7501 17.8752C10.7501 18.9106 11.5895 19.75 12.625 19.75V19.75C13.6604 19.75 14.4998 18.9105 14.4998 17.8751V17.8751C14.4998 16.8395 13.6603 16 12.6248 16L10.7501 16L10.7501 17.8752ZM10.7501 12.625C10.7501 13.6605 11.5896 14.5 12.6251 14.5L17.8748 14.5C18.9103 14.5 19.7498 13.6605 19.7498 12.625V12.625C19.7498 11.5895 18.9104 10.75 17.8748 10.75L12.6251 10.75C11.5896 10.75 10.7501 11.5895 10.7501 12.625V12.625Z"
                    fill="#ECB22E"
                  />
                  <path
